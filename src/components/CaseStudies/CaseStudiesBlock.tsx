...
const CaseBlock = () => {
  return (
    <section className="mb-20 md:mb-34 lg:mb-35">
      ...
      />
      <ul className="bg-dark grid grid-cols-1 gap-x-16 gap-y-10 rounded-2xl px-5 py-8 text-white sm:rounded-3xl sm:px-[45px] sm:py-[55px] md:grid-cols-2 lg:grid-cols-3 lg:gap-x-20 lg:rounded-[45px] xl:gap-x-32 xl:px-15 xl:py-17.5">
